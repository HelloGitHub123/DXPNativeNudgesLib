#
#  Be sure to run `pod spec lint DXPNativeNudgesLib.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "DXP Nudges Native manager SDK."

  spec.homepage     = "https://github.com/HelloGitHub123/DXPNativeNudgesLib"
  ...
  spec.source       = { :git => "https://github.com/HelloGitHub123/DXPNativeNudgesLib.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "DXPNativeNudgesLib/**/*.{h,m}"
